# A program that receives a sequence of integers - the distance to the pokemon. Then it will begin receiving integers, which will correspond to indexes in that sequence.
